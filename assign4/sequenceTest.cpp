...
#include "sequence.h"
namespace seqOfNum  = CS3358_SSII2019_A04_sequenceOfNum;
namespace seqOfChar = CS3358_SSII2019_A04_sequenceOfChar;
using namespace std;
...
{
   T<double> s1;  // A sequence of double for testing
   T<char> s2; // A sequence of char for testing
